...
-- Schema blogisw
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `blogisw` DEFAULT CHARACTER SET utf8 ;
USE `blogisw` ;

-- -----------------------------------------------------
-- Table `blogisw`.`autore`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `blogisw`.`autore` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `blogisw`.`articolo` (
  ...
  CONSTRAINT `fk_articolo_autore`
    FOREIGN KEY (`autore`)
    REFERENCES `blogisw`.`autore` (`idautore`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `blogisw`.`categoria` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `blogisw`.`articolo_ha_categoria` (
  ...
  CONSTRAINT `fk_articolo_has_categoria_articolo1`
    ...
    REFERENCES `blogisw`.`articolo` (`idarticolo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_articolo_has_categoria_categoria1`
    FOREIGN KEY (`categoria`)
    REFERENCES `blogisw`.`categoria` (`idcategoria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
